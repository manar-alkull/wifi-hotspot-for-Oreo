package com.sayraan.sayraan.system.hotspot;
...
public class MyOreoWifiManager {
    ...
    public static void useMagicActivityToTurnOn(final Context c,boolean turnOn) {
        MyOreoWifiManager mMyOreoWifiManager = new MyOreoWifiManager(c);
        if (turnOn) {
            MyOnStartTetheringCallback callback = new MyOnStartTetheringCallback() {
                @Override
                public void onTetheringStarted() {
                /*c.startForeground(FOREGROUND_ID,
            ...
            mMyOreoWifiManager = new MyOreoWifiManager(c);
